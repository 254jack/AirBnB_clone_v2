...
env.hosts = ['18.204.6.30', '	54.158.79.188']


def do_pack():
    """method to compress files in an archive"""
...
def do_deploy(archive_path):
    """method to distribute an archive to a server"""
...
def deploy():
    """a method that creates and distributes an archive to a web server"""
    filepath = do_pack()
    if filepath is None:
        return False
...
def do_clean(number=0):
    """a method that deletes out-of-date archives"""
